  ...
  return (
    <div className="grid lg:grid-cols-hero lg:h-[calc(100vh_-_96px)]">
        <section className="px-3 py-6 lg:px-14 h-full flex flex-col justify-center">
            <h2 className="font-extrabold text-3xl text-center text-primary leading-[48px_!important] lg:leading-[60px_!important] lg:text-5xl lg:text-left">The kind of <span className="text-soft-brown">furniture</span> you have been looking for</h2>
